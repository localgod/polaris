<template>
  <div class="space-y-6">
    ...
    <UCard>
      <div>
        <h2>Scope</h2>
        <p>The audit trail captures governance decisions — changes to policies, approvals, team structure, and system ownership. Operational data that changes frequently through automated processes (components discovered via SBOM, repositories, hashes, external references) is excluded.</p>

        <h2>Audited Events</h2>

        <h3>Governance Operations</h3>
        <ul>
          <li><strong>Policy lifecycle</strong> — creation, status changes (ACTIVATE, DEACTIVATE, ARCHIVE), deletion</li>
        ...
        <ul>
          ...
          <li><strong>Policy enforcement</strong> — policy-to-team application changes</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>entityType</strong> — Policy, User, Technology, etc.</li>
        ...
        <ul>
          ...
          <li><strong>Policy</strong> — status transitions, enforcement scope changes</li>
        ...
        <ul>
          ...
          <li>Entries are append-only with indefinite retention. No purge mechanism exists; implement one if retention policies require it.</li>
        </ul>
      </div>
    </UCard>
  </div>
