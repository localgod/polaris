...
const accessRows = [
  ...
  { element: 'API Tokens (own)', view: 'Authenticated', create: 'Authenticated', edit: '—', delete: 'Authenticated', notes: 'Self-managed from /profile; max 10 active tokens; value shown once' },
  { element: 'API Tokens (any user)', view: 'Superuser', create: 'Superuser', edit: '—', delete: 'Superuser', notes: 'Superusers manage tokens for technical users via the user detail page' },
...
const creationRows = [
  ...
  { element: 'API Tokens (own)', method: 'Generated by any authenticated user from their profile page (/profile)' },
  { element: 'API Tokens (technical users)', method: 'Generated via the UI by superusers on the user detail page' },
