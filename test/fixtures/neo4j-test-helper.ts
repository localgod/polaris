...
import { loadQuery, loadQueryWithAudit, injectOrderBy, injectWhereConditions } from '../../server/utils/query-loader'
...
declare global {
  ...
  var loadQueryWithAudit: (path: string) => Promise<string>
...
global.loadQueryWithAudit = loadQueryWithAudit
