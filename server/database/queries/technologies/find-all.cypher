...
// doesn't multiply into duplicate rows below (stewardTeamName is a single
...
WITH collect({t: t, team: team, componentCount: componentCount, constraintCount: constraintCount, approvals: approvals}) as allRows, count(t) as total
UNWIND allRows as row
WITH row.t as t, row.team as team, row.componentCount as componentCount, row.constraintCount as constraintCount, row.approvals as approvals, total
